...
class MainMenu():
	...
	def awake(self):
		self.playButton = Sprite(self.screen, (100, 100), (1, 1), 'Assets/gameicons/PNG/White/1x/forward.png')
		self.exitButton = Sprite(self.screen, (300, 100), (1, 1), 'Assets/gameicons/PNG/White/1x/power.png')
